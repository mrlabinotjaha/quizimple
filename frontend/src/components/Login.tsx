...
export function Login({ onSwitchToRegister, onBackToLanding }: LoginProps) {
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          ...
          <div className="flex-1 flex items-center">
            <div className="space-y-6">
              ...
              <p className="text-white/60 text-lg max-w-md">
                Build interactive quizzes, host live sessions, and track results with powerful analytics. Perfect for educators and teams.
              </p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 bg-[#FFFBF7] dark:bg-[#0D0D0F] flex items-center justify-center p-6 lg:p-12">
